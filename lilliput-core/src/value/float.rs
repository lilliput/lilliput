...
mod tests {
    ...
    #[test]
    fn display() {
        assert_eq!(format!("{}", FloatValue::try_from(4.2_f32).unwrap()), "4.2");
        assert_eq!(format!("{}", FloatValue::try_from(4.2_f64).unwrap()), "4.2");
    }

    #[test]
    fn debug() {
        assert_eq!(
            format!("{:?}", FloatValue::try_from(4.2_f32).unwrap()),
            "4.2"
        );
        assert_eq!(
            format!("{:?}", FloatValue::try_from(4.2_f64).unwrap()),
            "4.2"
        );
