    ...
    W: Write,
{
    ...
    pub fn encode_bytes_header(&mut self, len: usize) -> Result<()> {
        ...
        let len_bytes_header = MAX_LEN_WIDTH - len_width;
        self.push_bytes(&len_bytes[len_bytes_header..])?;
