...
//             .map(move |len| Header::String(StringHeader::new(len as usize, packing_mode)))
//     }
...
//     fn samples_iter(samples: usize, packing_mode: PackingMode) -> impl Iterator<Item = Header> {
//         sampling_values_iter::<u32>(samples)
//             .map(move |len| Header::Seq(SeqHeader::new(len as usize, packing_mode)))
//     }
...
//     fn samples_iter(samples: usize, packing_mode: PackingMode) -> impl Iterator<Item = Header> {
//         sampling_values_iter::<u32>(samples)
//             .map(move |len| Header::Map(MapHeader::new(len as usize, packing_mode)))
//     }
...
//     fn samples_iter(samples: usize) -> impl Iterator<Item = Header> {
//         sampling_values_iter::<u32>(samples)
//             .map(move |len| Header::Bytes(BytesHeader::new(len as usize)))
//     }
